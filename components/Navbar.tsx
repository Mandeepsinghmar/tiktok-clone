...
const Navbar = () => {
  ...
  return (
    <div className='w-full flex justify-around items-center border-b-2 border-gray-200 p-4'>
      <Link href='/'>
        <Image
          width={128}
          height={40}
      ...
      <div>
        {user ? (
          <div className='flex gap-10'>
            <Link href='/upload'>
              <button className='border-2 px-6 text-xl font-semibold flex items-center gap-2'>
                <IoMdAdd /> Upload
              </button>
            </Link>
